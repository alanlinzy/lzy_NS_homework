...
def create_chest_description(chest):
    ...
    if chest["locked"]:
        ...
        description += " The chest is open. There is a hammer"
        if "hammer" in chest["container"]:
            description += "There is a hammer. "
    return description
...
class EscapeRoomGame:
    ...
    def create_game(self, cheat=False):
        ...
        chest.triggers.append(lambda obj, cmd, *args: (cmd == "open") and chest.__setitem__("description", create_chest_description(chest)))#@C
