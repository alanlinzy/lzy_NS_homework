...
class clientProtocol(asyncio.Protocol):
    def __init__(self,loop):
        ...
        self.unique_id = ""
        self.username = "wli71"
        self.src_account = "wli71_account"
        self.dst_account = ""
        self.payment = 0
        self.receipt =""
        self.receipt_sig =""
    ...
    def data_received(self,data):
        ...
        for pk in self.deserializer.nextPackets():
            ...
            if pk.DEFINITION_IDENTIFIER == autograder.AutogradeTestStatus.DEFINITION_IDENTIFIER:
                ...
                password = "SOw2jvyyvn"#getpass.getpass("Enter password for {}: ".format(username))
...
if __name__=="__main__":
    ...
    add = input()
    port = input()
    coro = playground.create_connection(lambda:clientProtocol(loop),add,port)
